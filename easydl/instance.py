...
class Instance(AbstractObject):
    ...
    """
    def __init__(self, input_tensors: Union[AbstractTensor, Sequence[AbstractTensor]], output_tensor: AbstractTensor,
                 cache: Union[np.ndarray, Sequence[np.ndarray], None], batch_size: int):
        """
        ...
        """
        super().__init__()
        self.input_tensors: Union[AbstractTensor, Sequence[AbstractTensor]] = input_tensors
        self.output_tensor: AbstractTensor = output_tensor
        self.cache: Union[np.ndarray, Sequence[np.ndarray], None] = cache
